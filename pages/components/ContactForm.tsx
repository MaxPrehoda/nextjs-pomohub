...
We value your feedback, so please don&apos;t hesitate to reach out to us with any questions, comments, or suggestions you might have about our app. We&apos;d love to hear from you!</p>
...
</div><div className="left-12 top-72 border-[1px] border-pink-300 bg-pink-400 bg-opacity-30 p-4 rounded-md w-[17.5%] h[2%] text-zinc-50 absolute hover:bg-opacity-40"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="inline mr-2 w-6 h-6">
