        ...
        <div >
            <div className="relative gap-6 sm:flex-row md:flex-col lg:flex-row">
                <div>
                    ...
                    <input className="mt-2 text-base leading-7 text-white" type = "text" id = "name" required />
                </div>
                <div>
                    <label className="text-lg font-semibold leading-8 pl-2 text-white">Email </label>
                    <input className="mt-2 text-base leading-7 text-white" type = "text" id = "email" required />
                </div>
                <div>
                    <label className="text-lg font-semibold leading-8 text-white">Message </label>
                    <textarea className="mt-2 text-base leading-7 text-white" id = "message" required />
                </div>
